...
func (wq *WorkoutQuery) QueryWorkoutExercise() *WorkoutExerciseQuery {
	query := (&WorkoutExerciseClient{config: wq.config}).Query()
...
func (wq *WorkoutQuery) QueryUser() *UserQuery {
...
func (wq *WorkoutQuery) Clone() *WorkoutQuery {
	...
	return &WorkoutQuery{
		...
		withWorkoutExercise: wq.withWorkoutExercise.Clone(),
...
func (wq *WorkoutQuery) WithWorkoutExercise(opts ...func(*WorkoutExerciseQuery)) *WorkoutQuery {
	query := (&WorkoutExerciseClient{config: wq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	wq.withWorkoutExercise = query
	return wq
}

// WithUser tells the query-builder to eager-load the nodes that are connected to
// the "user" edge. The optional arguments are used to configure the query builder of the edge.
func (wq *WorkoutQuery) WithUser(opts ...func(*UserQuery)) *WorkoutQuery {
	query := (&UserClient{config: wq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (wq *WorkoutQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Workout, error) {
	...
	if query := wq.withWorkoutExercise; query != nil {
		if err := wq.loadWorkoutExercise(ctx, query, nodes,
			func(n *Workout) { n.Edges.WorkoutExercise = []*WorkoutExercise{} },
			func(n *Workout, e *WorkoutExercise) { n.Edges.WorkoutExercise = append(n.Edges.WorkoutExercise, e) }); err != nil {
			return nil, err
		}
	}
	if query := wq.withUser; query != nil {
		if err := wq.loadUser(ctx, query, nodes, nil,
			func(n *Workout, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (wq *WorkoutQuery) loadWorkoutExercise(ctx context.Context, query *WorkoutExerciseQuery, nodes []*Workout, init func(*Workout), assign func(*Workout, *WorkoutExercise)) error {
	...
	query.Where(predicate.WorkoutExercise(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(workout.WorkoutExerciseColumn), fks...))
	}))
...
func (wq *WorkoutQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Workout, init func(*Workout), assign func(*Workout, *User)) error {
