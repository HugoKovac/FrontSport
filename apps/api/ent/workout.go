...
func (e WorkoutEdges) WorkoutExerciseOrErr() ([]*WorkoutExercise, error) {
	if e.loadedTypes[0] {
...
// QueryWorkoutExercise queries the "workout_exercise" edge of the Workout entity.
func (w *Workout) QueryWorkoutExercise() *WorkoutExerciseQuery {
	return NewWorkoutClient(w.config).QueryWorkoutExercise(w)
}
