...
func (weq *WorkoutExerciseQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (weq *WorkoutExerciseQuery) FirstIDX(ctx context.Context) int {
...
func (weq *WorkoutExerciseQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (weq *WorkoutExerciseQuery) OnlyIDX(ctx context.Context) int {
...
func (weq *WorkoutExerciseQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (weq *WorkoutExerciseQuery) IDsX(ctx context.Context) []int {
	ids, err := weq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(workoutexercise.FieldExerciseID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.WorkoutExercise.Query().
//		Select(workoutexercise.FieldExerciseID).
//		Scan(ctx, &v)
...
func (weq *WorkoutExerciseQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(workoutexercise.Table, workoutexercise.Columns, sqlgraph.NewFieldSpec(workoutexercise.FieldID, field.TypeInt))
	_spec.From = weq.sql
